...
## Installation
Clone [Parse Server Repository](https://github.com/parse-community/parse-server). Supported version 7.2.0 and above.  
...
```
git clone --depth 1 --branch 7.2.0 https://github.com/parse-community/parse-server.git
cd parse-server
```
