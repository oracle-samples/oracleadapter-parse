...
describe('beforeLogin hook', () => {
  ...
  it_id('5656d6d7-65ef-43d1-8ca6-6942ae3614d5')('should have expected data in request', async done => {
    Parse.Cloud.beforeLogin(req => {
...
describe('afterLogin hook', () => {
  ...
  it_id('e86155c4-62e1-4c6e-ab4a-9ac6c87c60f2')('should have expected data in request', async done => {
    Parse.Cloud.afterLogin(req => {
      expect(req.object).toBeDefined();
...
describe('saveFile hooks', () => {
  ...
  it_id('dd474035-9600-4a62-9e73-a6db2678eace')('legacy hooks', async () => {
    await reconfigureServer({ filesAdapter: mockAdapter });
    const logger = require('../lib/logger').logger;
