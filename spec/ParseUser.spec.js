...
describe('allowExpiredAuthDataToken option', () => {
  ...
  it_id('c7c20c7b-a681-4b1c-8ae8-25f8f3d43227')('should default true', async () => {
    const logger = require('../lib/logger').logger;
    const logSpy = spyOn(logger, 'warn').and.callFake(() => {});
...
describe('Parse.User testing', () => {
  ...
  it_id('84fccea9-6c38-4cd0-97db-19dd15813222')('should allow login with expired authData token by default', async () => {
    const provider = {
      authData: {
        id: '12345',
        access_token: 'token',
